...
$("#nombre").blur(() => {
    ...
    if (!nombreExp.test(nombre)) {
        $("#checkNombre").prop("src", "../images/form/equis.png");
    } else {
        $("#checkNombre").prop("src", "../images/form/check.png");
        valido++;
    }
});
...
$("#apellidos").blur(() => {
    ...
    if (!apeExp.test(apellidos)) {
        $("#checkApellidos").prop("src", "../images/form/equis.png");
    } else {
        $("#checkApellidos").prop("src", "../images/form/check.png");
        valido++;
    }
});
$("#dni").blur(() => {
    ...
    if (!dniExp.test(dni)) {
        $("#checkDNI").prop("src", "../images/form/equis.png");
    } else {
        $("#checkDNI").prop("src", "../images/form/check.png");
        valido++;
    }
});
$("#email").blur(() => {
    ...
    if (!emailExp.test(email)) {
        $("#checkEmail").prop("src", "../images/form/equis.png");
    } else {
        $("#checkEmail").prop("src", "../images/form/check.png");
        valido++;
    }
});
$("#tlf").blur(() => {
    ...
    if (!tlfExp.test(tlf)) {
        $("#checkTlf").prop("src", "../images/form/equis.png");
    } else {
        $("#checkTlf").prop("src", "../images/form/check.png");
        valido++;
    }
});
$("#derecha1").click(() => {
...
$("#usuario").blur(() => {
    ...
    if (!userExp.test(usuario)) {
        $("#checkUser").prop("src", "../images/form/equis.png");
    } else {
        $("#checkUser").prop("src", "../images/form/check.png");
        valido++;
    }
});
$("#password1").blur(() => {
    ...
    if (!userExp.test(contrasenia)) {
        $("#checkPass").prop("src", "../images/form/equis.png");
    } else {
        $("#checkPass").prop("src", "../images/form/check.png");
        valido++;
    }
});
$("#password2").blur(() => {
    ...
    if (contrasenia1 != contrasenia2) {
        $("#checkPass2").prop("src", "../images/form/equis.png");
    } else {
        $("#checkPass2").prop("src", "../images/form/check.png");
        valido++;
    }
});
...
$("#iban").blur(() => {
    ...
    if (!ibanExp.test(iban)) {
        $("#checkIban").prop("src", "../images/form/equis.png");
    } else {
        $("#checkIban").prop("src", "../images/form/check.png");
